"""
Django settings for tedisapp project.
...
ALLOWED_HOSTS = ['159.223.102.156', '127.0.0.1', 'www.khoabubemi.click', 'khoabubemi.click']
...
WSGI_APPLICATION = 'tedisapp.wsgi.application'

# CSRF_TRUSTED_ORIGINS=['https://tedis-saleagreement.herokuapp.com']
