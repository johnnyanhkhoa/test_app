...
class Quotation(models.Model):
    ...
    quotation_date = models.DateField(null=True, default=now)
    quotation_status = models.ForeignKey(Status, on_delete=models.PROTECT, null=True)
    status_date = models.DateField(null=True, default=now)
...
class Contract(models.Model):
    ...
    contract_date = models.DateField(null=True, default=now)
    valid_from_date = models.DateField(null=True, default=now)
    valid_to_date = models.DateField(null=True, default=now)
